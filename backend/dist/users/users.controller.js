...
let UsersController = class UsersController {
    ...
    async addDevice(req, createDeviceDto) {
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Add a new device for push notifications' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Device added successfully' }),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, create_device_dto_1.CreateDeviceDto]),
    __metadata("design:returntype", Promise)
], UsersController.prototype, "addDevice", null);
__decorate([
    (0, common_1.Delete)('me/devices/:deviceId'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Remove a device' }),
    (0, swagger_1.ApiResponse)({ status: 204, description: 'Device removed successfully' }),
    __param(0, (0, common_1.Request)()),
