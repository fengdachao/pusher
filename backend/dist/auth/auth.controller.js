...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.CREATED, description: 'User successfully registered' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.BAD_REQUEST, description: 'Invalid input data' }),
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.CONFLICT, description: 'User already exists' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: common_1.HttpStatus.OK, description: 'Token successfully refreshed' }),
